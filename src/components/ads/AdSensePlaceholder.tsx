export function AdSensePlaceholder({ label }: { label?: string }) {
  return (
    <div className="flex min-h-[120px] w-full items-center justify-center rounded-lg border border-dashed border-white/20 bg-brand-card/50 px-4 py-8 text-center">
      <div>
